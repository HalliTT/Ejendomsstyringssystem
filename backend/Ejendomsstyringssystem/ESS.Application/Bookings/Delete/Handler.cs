...
namespace ESS.Application.Bookings.Delete
{
    public sealed class Handler : IRequestHandler<Command, bool>
    {
        ...
        public async Task<bool> Handle(Command command, CancellationToken ct)
        {
            ...
            var rentalOption = await _rentalOptionRepository.GetByIdAsync(existing.RentalOptionId, ct);
            ...
            return await _bookingRepository.DeleteAsync(command.BookingId, ct);
        }
    }
}
